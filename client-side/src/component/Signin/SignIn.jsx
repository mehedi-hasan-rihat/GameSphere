...
export default function SignIn() {
  ...
  useEffect(() => {
    if (error) {
      toast.error(
        "Password must have an Uppercase, Lowercase letter & at least 6 character"
      );
      setError(false);
    }
  }, [error]);
  ...
  return (
    <div className="">
       ...
       <div className="shadow-md  mt-20  p-3 rounded-md max-w-[1500px] mx-auto">
              ...
              <div className="lg:grid  lg:grid-cols-12">
                <section className="relative flex  items-end bg-gray-900 lg:col-span-5  xl:col-span-6">
                  ...
                  <div className="hidden lg:relative lg:block lg:p-12">
                    ...
                    Unlock exclusive features and join the community of passionate gamers. Log in to access personalized game recommendations, leave reviews, and connect with fellow enthusiasts. Don't have an account yet? Sign up now to be a part of the action and let your voice be heard in the gaming world!
                    </p>
                  </div>
                </section>
